...
public class GameInfo implements Serializable {
	...
	public void set_participants(int item) {
		participants = item;
	}

	public void set_roundAnswer(String item) {
		roundAnswer = item;
	}

	public void set_roundNum(int item) {
		roundNum = item;
	}

	public void inc_participants() {
		participants += 1;
	}

	public void dec_participants() {
		participants -= 1;
	}
}